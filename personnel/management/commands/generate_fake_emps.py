...
class Command(BaseCommand):
    help = 'Génère 20 employés avec des données fictives'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Poids pour une répartition inégale
        ...
        self.stdout.write("Création de 20 employés...")
        created = 0
        attempts = 0
        ...
        while created < 20 and attempts < 100:
            ...
            try:
                ...
                self.stdout.write(self.style.ERROR(f"Erreur lors de la création d'un employé: {e}"))

        self.stdout.write(self.style.SUCCESS(f"{created} employés créés avec succès !"))
